...
angular.module('events', ['resources.events', 'services.breadcrumbs', 'services.pluginsProvider']).
config(['pluginsProvider', function(pluginsProvider){
    pluginsProvider.register('Events', '/events', {
        controller: 'EventsListCtrl',
        templateUrl: '/static/js/app/events/events.tpl.html',
        resolve: {
            events: function(Events){
                return Events.getFirstPage();
            }
        }
    })
}]);
