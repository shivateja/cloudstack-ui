...
angular.module('templates', ['resources.templates', 'services.breadcrumbs', 'services.pluginsProvider']).
config(['pluginsProvider', function(pluginsProvider){
    pluginsProvider.register('Templates', '/templates', {
        controller: 'TemplatesListCtrl',
        templateUrl: 'table.html',
        resolve: {
            templates: function(Templates){
                return Templates.getFirstPage();
            }
        }
    })
}]);
