...
angular.module('services.notifications').factory('Notifications', function(){
    ...
    /*
     * These functions were useful with basic notifications previously implemented
     * and are not useful with bootstrap-growl
     * might need them later when the implementation needs to changed
